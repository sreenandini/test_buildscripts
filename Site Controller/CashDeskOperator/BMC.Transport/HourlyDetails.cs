...
namespace BMC.Transport.CashDeskOperatorEntity
{
    public class HourlyDetails
    {
        ...
        public bool IsDetailsRecord { get; set; }
    }
    ...
    public partial class HourlyDetailEntity 
    {
        private int _ID;
        ...
        //[global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_Day", DbType = "varchar(5)")]
        public string Day
        {
            get
            {
    ...
    public partial class HourlyStatisticsTypeEntity 
    {
    ...
    public partial class HourlyFilterByValueEntity 
    {
