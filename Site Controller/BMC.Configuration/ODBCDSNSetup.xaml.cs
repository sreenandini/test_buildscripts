namespace BMC.ExchangeConfig
{
    ...
    public partial class ODBCDSNSetup : Window
    {
            ...
            try
            {
                ...
                if (rbSQLAuthentication.IsChecked == true)
                {
                    if (ValidateText(txtDSReferName, "Data Source Reference Name"))
                    {
                                    ...
                                    if (ValidateText(cmbDefaultDB, "Default Database"))
                                    {
                                        if (ValidateText(cmbDefaultLang, "Default Language"))
                                        {
                                            ...
                                            if (BMC.DBInterface.ExchangeConfig.DBBuilder.TestODBCConnection(connectionstring))
                                                MessageBox.ShowBox("MessageID61", BMC_Icon.Information);
                                            else
                                                MessageBox.ShowBox("MessageID75", BMC_Icon.Error);
                                        }
                                        else
                                        {
                                            MessageBox.ShowBox("MessageID67", BMC_Icon.Information);
                                        }
                                    }
                                    else
                                    {
                                        MessageBox.ShowBox("MessageID66", BMC_Icon.Information);
                                    }
                                }
                                else
                                {
                        ...
                        {
                            MessageBox.ShowBox("MessageID68", BMC_Icon.Information);
                        }
                    }
                }
                else
        ...
        //                                        MessageBox.ShowBox("MessageID62", BMC_Icon.Information);
        //                                    }
        //                                    else
        //                                    {
        //                                        MessageBox.ShowBox("MessageID76", BMC_Icon.Error);
        //                                    }   
        //                                }
        //                                else
        //                                {
        ...
        //        }
        //        else
        //            MessageBox.ShowBox("MessageID64", BMC_Icon.Information);                          
        //    }
        //    catch (Exception ex)
        //    {
        //        MessageBox.ShowBox("MessageID74", BMC_Icon.Error);
        ...
        private void btnClear_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                MessageBox.ShowBox("MessageID65", BMC_Icon.Information);
            }
            finally
            {
