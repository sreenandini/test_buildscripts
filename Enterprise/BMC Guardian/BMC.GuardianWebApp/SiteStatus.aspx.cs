...
public partial class SiteStatus : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(SiteName))
        {
            ...
            SiteStatusDetails _siteStatus = GuardianBL.GetSiteStatusDetails(GuardianBL.GetLastProcessedDetails(siteStatus), Convert.ToString(Session["UserName"]), Convert.ToInt32(ConfigManager.Read("ProxyTimeOut")), 0);
