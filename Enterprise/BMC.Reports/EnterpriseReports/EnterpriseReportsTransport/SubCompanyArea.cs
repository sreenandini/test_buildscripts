...
{
    [Table(Name = "dbo.Sub_Company_Area")]
    public partial class SubCompanyArea : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnSub_Company_Area_IDChanging(int value);
        ...
        partial void OnSub_Company_Area_NameChanging(string value);
        partial void OnSub_Company_Area_NameChanged();
        partial void OnStaff_IDChanging(System.Nullable<int> value);
        partial void OnStaff_IDChanged();
        partial void OnSub_Company_Area_DescriptionChanging(string value);
        partial void OnSub_Company_Area_DescriptionChanged();
        #endregion

        public SubCompanyArea()
        {
            OnCreated();
        }

        [Column(Storage = "_Sub_Company_Area_ID", AutoSync = AutoSync.OnInsert, DbType = "Int NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
        ...
        public string Sub_Company_Area_Name
        {
            ...
            set
            {
                ...
                {
                    this.OnSub_Company_Area_NameChanging(value);
                    this.SendPropertyChanging();
                    this._Sub_Company_Area_Name = value;
                    this.SendPropertyChanged("Sub_Company_Area_Name");
                    this.OnSub_Company_Area_NameChanged();
                }
            }
        }
        ...
        public string Sub_Company_Area_Description
        {
            ...
            set
            {
                ...
                {
                    this.OnSub_Company_Area_DescriptionChanging(value);
                    this.SendPropertyChanging();
                    this._Sub_Company_Area_Description = value;
                    this.SendPropertyChanged("Sub_Company_Area_Description");
                    this.OnSub_Company_Area_DescriptionChanged();
                }
            }
        }
