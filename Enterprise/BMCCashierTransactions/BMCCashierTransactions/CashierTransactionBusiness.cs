...
namespace BMCCashierTransactions
{
    public class TreasuryTransactions
    {
        ...
        CDMDataContext oDataContext = new CDMDataContext();
        #endregion
        ...
        {
            return oDataContext.GetCompanyDetails().ToList();
        ...
        internal void GetSite_Code_Name(int SITEID, out string SITECODE, out string SITENAME)
        {
        ...
        internal DataSet GetCashDeskReconcilationDetails(DateTime StartDate, DateTime EndDate,int SiteID,int RouteNo, int UserNo)
        {
            return cashdeskmanagerDataAccess.GetCashDeskReconcilationDetails(StartDate, EndDate, SiteID, RouteNo, UserNo);
        }


        internal DataSet GetSystemBalancingDetails(DateTime StartDate, DateTime EndDate, int _SITEID, int RouteNo, int UserNo)
        {
            return cashdeskmanagerDataAccess.GetSystemBalancingDetails(StartDate, EndDate, _SITEID, RouteNo, UserNo);
        }

        internal string GetRegion_Site(int SITEID)
        {
        ...
        internal DataSet GetCashDeskMovementDetails(DateTime StartDate, DateTime EndDate, int _SITEID,string sRegion,int RouteNo, int UserNo)
        {
        ...
        public bool CheckViewTicketAccess()
        {
            var result = cashdeskmanagerDataAccess.CheckAccessForViewTicketNumber(Program.nUserID);
            return result;
        }

        internal ISingleResult<CashierTransactions> GetCashierTransactions(DateTime startdate,DateTime enddate,int siteid,int RouteNo, int UserNo)
        {
        ...
        {
            return oDataContext.GetInitialSettings();
        }
        ...
        internal DataSet GetCashierHistory( DateTime startDate, DateTime endDate, int nSiteID, int Route_No, int User_No)
        {
