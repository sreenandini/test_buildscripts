...
namespace BMCCashierTransactions
{
    public class CashDeskManagerDataAccess
    {
        ...
        public List<CRMGetRoutesBySiteID> GetRoutes(int? SiteID)
        {
            try
            {
                using (CDMDataContext context = new CDMDataContext())
        ...
        internal DataSet GetSystemBalancingDetails(DateTime StartDate, DateTime EndDate, int site, int RouteNo, int UserNo)
        {
        ...
        internal DataSet GetCashDeskMovementDetails(DateTime StartDate, DateTime EndDate, int site, string sRegion, int RouteNo, int UserNo)
        {
