...
using BMCCashierTransactions.Reports;
...
namespace BMCCashierTransactions
{
    public partial class ReportViewer : Form
    {
       ...
       //Get Currency Symbol based on Setting from Database
        ...
        internal void showActiveReport(DataSet _DtDetails, DateTime _FromDate, DateTime _ToDate, string _SiteName,ReportOptions eReport,string sPath)
        {
            try
            {
                ...
                if (eReport == ReportOptions.Export)
                {
                ...
                else if (eReport == ReportOptions.Print)
                {
        ...
        internal void showVOIDReport(string _CODE, DataSet _DtDetails, DateTime _FromDate, DateTime _ToDate, string _SiteName, ReportOptions eReport, string sPath)
        {
        ...
        internal void showPROMOReport(DataSet _DtDetails, DateTime _FromDate, DateTime _ToDate, string _SiteName, ReportOptions eReport, string sPath)
        {
            try
            {
        ...
        internal void showEXCEPReport(DataSet _DtDetails, DateTime _FromDate, DateTime _ToDate, string _SiteName, ReportOptions eReport, string sPath)
        {
            try
            {
        ...
        internal void showLIABILITYReport(DataSet _DtDetails, DateTime _FromDate, DateTime _ToDate, string _SiteName, ReportOptions eReport, string sPath)
        {
            try
            {
