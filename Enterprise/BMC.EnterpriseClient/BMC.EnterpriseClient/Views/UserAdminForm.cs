...
namespace BMC.EnterpriseClient.Views
{
    ...
    {
        public UserAdminForm(string UserName)
        {
            InitializeComponent();
            _UserName = UserName;
          ...
          private void SetTagProperty()
        {
            try
            {
                ...
                this.btnNew.Tag = "Key_NewUserCaption";
               ...
               // this.UserAdminForm.Tag = "Key_UserAdmin";
        ...
        private void ChkStockController_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void FrmAdminUserAll_Load(object sender, EventArgs e)
        {
        ...
        private void Form_Load()
        {
            try
            {
                ...
                {
                    LstSurname_SelectedIndexChanged(LstSurname, null);
                }
                else
                {
            ...
            try
            {
                if ((!Update) && LstSurname_ind != LstSurname.SelectedIndex)
                {
                    ...
                    if (LstSurname.SelectedIndex != -1)
                    {
                        ...
                        UserTableUserID = staff.Staff_ID;
        ...
        void LoadStaffDetails(int Staff_ID)
        {
            try
            {
                ...
                if (lstStaff.Count > 0)
                {
                    ...
                    {
                        _collCustomerIncluded.Add(customerIncluded);
                    }
        ...
        bool ValidateControls(ref string ErrorMsg)
        {
            ...
            try
            {
                ...
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_ENTERNAME");// "Please Enter A Surname";
                    txtSurname.Focus();
                    retVal = false;
                }
                else if (txtSurname.Text.Trim().StartsWith("0"))
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_ZEROUSERNAME"); //"The User Name cannot start with Zero";
                    txtSurname.Focus();
                    retVal = false;
                }
                else if (!(new Regex(strAllowedChar).IsMatch(TxtStaffUserName.Text)))
                {
                    ErrorMsg = "The User Name You have Entered Is Not Valid" + System.Environment.NewLine + "Please Enter A Different One";//doubt
                ...
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_FIRSTNAME"); //"Please Enter A First Name";
                    TxtFirstName.Focus();
                    retVal = false;
                }
                ...
                {
                    ErrorMsg = "The Windows User Name You have Entered Is Not Valid" + System.Environment.NewLine + "Please Enter A Different One";//doubt
                    txtWindowsUsername.Focus();
                    retVal = false;
                }
                else if (String.IsNullOrEmpty(TxtPassword.Text) && NewUser)
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_CHECKPASSWORD");           //"Please Enter And Check A Password";
                    TxtPassword.Focus();
                    retVal = false;
                }
                //Length > 0
                ...
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_CHECKPASSWORD");      //"Please Enter Valid HomePhone Number ";
                    TxtHomePhone.Focus();
                    retVal = false;
                }
                else if (!(TxtMobilePhone.Text.IsNumeric() && TxtMobilePhone.Text.IsLengthGreaterThanZero()) && NewUser)
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_PHONENUMBER"); //"Please Enter Valid MobilePhone Number ";
                    TxtMobilePhone.Focus();
                    retVal = false;
                }
                else if (!(TxtPersonnelNo.Text.IsNumeric() && TxtPersonnelNo.Text.IsLengthGreaterThanZero()) && NewUser)
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "Please Enter Valid Personnel Number"); //"Please Enter Valid Personnel Number ";
                    TxtPersonnelNo.Focus();
                    retVal = false;
                }
                else if (!(TxtExtensionNumber.Text.IsNumeric() && TxtExtensionNumber.Text.IsLengthGreaterThanZero()) && NewUser)
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_EXTENSIONNUMBER"); //"Please Enter Valid Extension Number ";
                    TxtExtensionNumber.Focus();
                    retVal = false;
                }
                else if (!txtEmail.Text.IsValidEmail() && NewUser)
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_EMAILID"); //"The E-Mail ID is not in correct format.";
                    txtEmail.Focus();
                    retVal = false;
                ...
                {
                    ErrorMsg = this.GetResourceTextByKey(1, "MSG_USERADMIN_PASSWORD5CHAR"); //"Please enter a password text with minimum 5 characters.";
                    TxtPassword.Focus();
                    retVal = false;
                }
                else if (TxtPassword.Text != TxtPasswordCheck.Text && NewUser)
                {
                    ErrorMsg = "The Password And The Password Check You have Entered Do Not Match" + System.Environment.NewLine + "Please Enter Them Both Again";//doubt
        ...
        private void BtnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                if (BtnEdit.Text.Equals(this.GetResourceTextByKey("Key_EditCaption")))          // "Ed&it" - Key_EditCaption
                {
                    UnLockControls();
                    ...
                    BtnUpdate.Text = this.GetResourceTextByKey("Key_UpdateCaption");          //"U&pdate" - Key_UpdateCaption
                    btnNew.Visible = false;
                    //BtnForeColour.Visible = true;
                    //BtnBackColour.Visible = true; 
                    BtnEdit.Text = this.GetResourceTextByKey("Key_CancelCaption");           // "Cance&l" - Key_CancelCaption
                ...
                {
                    BtnEdit.Text = this.GetResourceTextByKey("Key_EditCaption");         //"Edi&t" - Key_EditCaption
                    btnCancel_Click();
                }
        ...
        void btnCancel_Click()
        {
            try
            {
                ...
                //BtnNew.Visible = CheckSecurity("HQ_Admin_Users_Editall")
        ...
        private void BtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (ValidateControls(ref ErrorMsg))
            {
                ...
                if (NewUser)
                {
                    ...
                    Win32Extensions.ShowInfoMessageBox(this, this.GetResourceTextByKey(1, "MSG_USERADMIN_INSERT"), this.Text);
                ...
                else
                {
                    ...
                    if (UserTableUserID != 0)
                    {
                       ...
                       // Win32Extensions.ShowInfoMessageBox("User Details Updated Successfully");
                        Win32Extensions.ShowInfoMessageBox(this, this.GetResourceTextByKey(1, "MSG_USERADMIN_UPDATE"), this.Text);
                    }
                }
            }
            else
        ...
        private void btnAssignSite_Click(object sender, EventArgs e)
        {
            if (UserTableUserID == 0)
              //  Win32Extensions.ShowInfoMessageBox("Edit the user details, Update and click Edit button again to assign sites to user.");
                Win32Extensions.ShowInfoMessageBox(this, this.GetResourceTextByKey(1, "MSG_USERADMIN_USERDETAILS"), this.Text);
            else
            {
                if (File.Exists(Application.StartupPath + @"\BMCUserSiteAdmin.exe"))
                {
                  ...
                  //  Win32Extensions.ShowInfoMessageBox("The User Site Admin package is not currently installed.");
                    Win32Extensions.ShowInfoMessageBox(this, this.GetResourceTextByKey(1, "MSG_USERADMIN_USERSITEADMIN"), this.Text);
        ...
        private void btnResetPassword_Click(object sender, EventArgs e)
        {
            ...
            if (UserTableUserID == 0)
            {
                ...
                Win32Extensions.ShowInfoMessageBox(this,this.GetResourceTextByKey(1, "MSG_USERADMIN_EDITUSER"),this.Text);
                return;
            }
            else
            {
               // if (Win32Extensions.ShowQuestionMessageBox("Do you wish to reset the password?") == DialogResult.Yes)
                if (Win32Extensions.ShowQuestionMessageBox(this, this.GetResourceTextByKey(1, "MSG_USERADMIN_RESETPASSWORD"), this.Text) == DialogResult.No)
                {
                    ...
                    if (sResult != "Unable to Reset")
                    {
                      ...
                      //  Win32Extensions.ShowInfoMessageBox("New Password is :" + sResult);
                        Win32Extensions.ShowInfoMessageBox(this, this.GetResourceTextByKey(1, "MSG_USERADMIN_NEWPASSWORD"), this.Text);//doubt
                        ...
                        if (BMCSecurityMethod.InsertPassword(ref UserID, ref sEncPass))
                          //  Win32Extensions.ShowInfoMessageBox("Password updated successfully");
                            Win32Extensions.ShowInfoMessageBox(this, this.GetResourceTextByKey(1, "MSG_USERADMIN_PASSWORDUPDATE"), this.Text);
                        else
                         //   Win32Extensions.ShowInfoMessageBox("Password not updated");
                            Win32Extensions.ShowInfoMessageBox(this, this.GetResourceTextByKey(1, "MSG_USERADMIN_PASSWORDNOTUPDATE"), this.Text);
