...
{
    public partial class frmUserSiteAccess :Form
    {

        UserSiteAccess instance = null;
        public frmUserSiteAccess()
        {
            InitializeComponent();
            LoadAccess();
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Customer Access updated Successfully", "User Site Access", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
