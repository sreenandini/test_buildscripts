...
namespace BMC.EnterpriseDataAccess
{
    public partial class EnterpriseDataContext
    {
        ...
        /// <returns></returns>
        [Function(Name = "dbo.rsp_AssetReport")]
        public ISingleResult<rsp_AssetReportResult> AssetReport([Parameter(Name = "StartDate", DbType = "VarChar(38)")] string startDate, [Parameter(Name = "EndDate", DbType = "VarChar(38)")] string endDate, [Parameter(Name = "SiteID", DbType = "Int")] System.Nullable<int> siteID, [Parameter(Name = "Category", DbType = "Int")] System.Nullable<int> category)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), startDate, endDate, siteID, category);
            return ((ISingleResult<rsp_AssetReportResult>)(result.ReturnValue));
        }

        /// <summary>
        /// Get teh Asset Detailed history report details
        /// </summary>
        /// <param name="bar_Position_ID"></param>
        /// <param name="isDetailed"></param>
        /// <returns></returns>
        [Function(Name = "dbo.rsp_GetDetailedHistory")]
        public ISingleResult<rsp_GetDetailedHistoryResult> DetailedHistory([Parameter(Name = "Bar_Position_ID", DbType = "Int")] System.Nullable<int> bar_Position_ID, [Parameter(Name = "IsDetailed", DbType = "Bit")] System.Nullable<bool> isDetailed, [Parameter(Name = "SiteID", DbType = "Int")] System.Nullable<int> siteID)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), bar_Position_ID, isDetailed, siteID);
            return ((ISingleResult<rsp_GetDetailedHistoryResult>)(result.ReturnValue));
        }
        /// <summary>
        /// Get the BMC Version
        /// </summary>
        ...
        public partial class rsp_AssetReportResult
        {
        ...
        public partial class rsp_GetDetailedHistoryResult
        {
            ...
            public rsp_GetDetailedHistoryResult()
            {
            }
