...
namespace BMC.EnterpriseDataAccess
{
    ...
    public partial class rsp_GetInitialSettingsResult
    {
        ...
        private System.Nullable<bool> _ShowCollectionReport;

        public rsp_GetInitialSettingsResult()
        {
        }
        ...
        [Column(Storage = "_ShowCollectionReport", DbType = "Bit")]
        public System.Nullable<bool> ShowCollectionReport
        {
            get
            {
