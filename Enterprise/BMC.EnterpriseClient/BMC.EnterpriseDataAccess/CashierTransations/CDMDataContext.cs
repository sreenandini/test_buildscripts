...
namespace BMC.EnterpriseDataAccess
{
    ...
    public partial class EnterpriseDataContext
    {
        ...
        public ISingleResult<SProcResult> GetBMCVersion2()
        {
        ...
        public ISingleResult<CashierTransactionsDA> GetCashierTransactions(
            ...
            [Parameter(Name = "User_No", DbType = "Int")] System.Nullable<int> User_No)
        {
            ...
            return ((ISingleResult<CashierTransactionsDA>)(result.ReturnValue));
        }
        ...
        public ISingleResult<rsp_GetCashierTransactionSettingsResult> GetInitialSettings2()
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())));
    ...
    public partial class CashierTransactionsDA
    {
