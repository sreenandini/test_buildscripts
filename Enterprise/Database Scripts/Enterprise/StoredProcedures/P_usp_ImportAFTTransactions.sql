...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_ImportAFTTransactions]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_ImportAFTTransactions]
GO
...
-- ===================================================================================================================================    
-- StoredProcedure [dbo].[usp_InsertAFTTransactions]    
-- -----------------------------------------------------------------------------------------------------------------------------------    
--    
...
-- ===================================================================================================================================    
CREATE PROCEDURE usp_ImportAFTTransactions
(  
 @doc xml  
)  
as  
