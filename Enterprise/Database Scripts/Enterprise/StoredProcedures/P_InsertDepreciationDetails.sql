...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InsertDepreciationDetails]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InsertDepreciationDetails]
GO
...
CREATE PROCEDURE [dbo].[InsertDepreciationDetails]
