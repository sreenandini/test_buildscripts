...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_PlannedMachineConvertion]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_PlannedMachineConvertion]
GO
...
--------------------------------------------------------------------------       
--      
-- Description: Planned convertion of a machine from one to another      
--          
--    Steps      
...
-- Revision History      
--       
-- Naveen     21/08/2008     Created    
-- Renjish    26/06/2009	 Modifed the code to skip the 'expire the old machine' step.    
-- Renjish    10/07/2009     Changed the logic to expire the machine to converted state.
-- Renjish    20/08/2009     Changed the logic to directly update the machine id without the greater than zero check.
---------------------------------------------------------------------------       
CREATE PROCEDURE [dbo].[usp_PlannedMachineConvertion]    
...
AS      
  ...
  SET @STOCK_CONVERTED = 107 -- Planned Convertion    
...
--  )      
--      
--  SELECT [Bar_Position_ID],    --         @NewMachineID,     -- [Machine_ID]      
--         [Datapak_ID],      
--         [Depot_ID],      
--         [CD_Program_ID],      
--         [Duty_ID],      
