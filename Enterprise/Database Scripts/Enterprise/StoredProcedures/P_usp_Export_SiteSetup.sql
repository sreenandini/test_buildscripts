...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_Export_SiteSetup]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_Export_SiteSetup]
GO
...
CREATE PROCEDURE [dbo].[usp_Export_SiteSetup]
(
...
AS
/*****************************************************************************************************
DESCRIPTION		: Procedure to Export Site Information to the site 
