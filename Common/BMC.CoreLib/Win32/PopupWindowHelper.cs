...
namespace BMC.CoreLib.Win32
{
    ...
    public class PopupWindowHelper : NativeWindow
    {
        ...
        public PopupWindowHelper(Form owner, Form popup)
            : this()
        {
            this.Owner = owner;
            this.Popup = popup;
        ...
        public Form Popup
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    value.ShowInTaskbar = false;
                    value.TopMost = true;
                    value.Paint += new PaintEventHandler(Popup_Paint);
                }
            }
        }
        ...
        {
            Rectangle borderRect = new Rectangle(popup.Location, popup.Size);
            borderRect.Width -= 1;
            borderRect.Height -= 1;
        ...
        {
            ModuleProc PROC = new ModuleProc("PopupFormHelper", "PopupClosed");
