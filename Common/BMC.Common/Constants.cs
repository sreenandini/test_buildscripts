...
namespace BMC.Common
{
    public static class Constants
    {
        ...
        public const string CONSTANT_RSP_EXPORTAUTOINSTALLATION = "rsp_ExportAutoInstallationToXML";
        ...
        public const string CONSTANT_USP_ALLEXPORTDATAFORSITES = "rsp_GetAllExportDataForSites";
        ...
        public const string CONSTANT_RSP_GETBARPOSITIONMACHINESTATUS = "rsp_GetBarPositionMachineStatus";
        ...
        public const string CONSTANT_USP_GETUNPROCESSEDRECORSFROMIH_FORSITES = "USP_GetUnprocessedRecordsFromImportHistoryForSites";
        ...
        public const string CONSTANT_USP_INSERTINSTALLATIONGAME = "usp_Insert_Installation_Game_Details";
        ...
        public const string CONSTANT_WEBMETHOD_IMPORTCROSSTICKETING = "ImportCrossTicketing";
        ...
        public const string CONSTANT_WEBMETHOD_IMPORTAUTOINSTALLATION = "ImportAutoinstallation";
        ...
        //BMC scheduler
        public const string DeleteScheduleJob = "usp_Delete_ScheduleJob";
        public const string InsertScheduleJob = "usp_Insert_ScheduleJob";
        public const string SelectScheduleJob = "rsp_FetchJobDetails";

        public const string CONSTANT_RSP_GETAAMSDETAILSFOREXPORT = "rsp_GetAAMSDetailsForExport";

        //Newly Added for Cross Ticketing Config
        public const string CONSTANT_RSP_EXPORTCROSSTICKETING = "rsp_ExportCrossTicketingDetailsAsXML";

        //Newly Added for STM Export Service
        public const string CONSTANT_RSP_EXPORTSTM = "rsp_GetSTMExport_History";
        public const string CONSTANT_USP_UPDATESTMEXPORTHISTORY = "usp_UpdateSTMExportHistoryDetails";

        //Declaration
        public const string CONSTANT_RSP_EXPORTINSERTEDCOLLECTIONDECLARATION = "rsp_ExportInsertedCollectionDeclaration";
        public const string CONSTANT_USP_EXPORT_HISTORY = "usp_Export_History";
    }
}
