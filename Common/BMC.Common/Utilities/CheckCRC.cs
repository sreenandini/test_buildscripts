...
namespace BMC.Common.Utilities
{
    public class clsCheckCRC
    {
        ...
        public bool CheckCRC(string sBarcode, long lValue, string SiteCode, string Datapak)
        {
            ...
            {
                LogManagement.LogManager.WriteLog("CheckCRC Message:" + ex.Message, LogManagement.LogManager.enumLogLevel.Error);
                return false;
            }
        }
        ...
        private string CreateCRC(string sBarCode, long lAmount)
        {
            ...
            {
                LogManagement.LogManager.WriteLog("CreateCRC Message:" + ex.Message, LogManagement.LogManager.enumLogLevel.Error);
                return "";
            }
        }
        ...
        private void GetAmt(long Amt, byte[] Outbuf)
        {
            ...
            {
                LogManagement.LogManager.WriteLog("GetAmt Message:" + ex.Message, LogManagement.LogManager.enumLogLevel.Error);
