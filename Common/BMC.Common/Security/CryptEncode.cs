...
namespace BMC.Common.Security
{
    public class CryptEncode
    {
        ...
        private static X509Certificate2 x509Certificate2PublicKey;
        ...
        public static string Encrypt(string original, string key)
        {
            ...
            if (isRsa == "true".ToUpper())
            {
                ...
                original = Encoding.Default.GetString(encryptedMessagesInBytes);

            }

            if (isTripleDES == "true".ToUpper())
            {
        ...
        public static string Decrypt(string encrypted, string key, Encoding encoding)
        {
            ...
            if (isRsa == "true".ToUpper())
            {
                ...
                var buffer = encoding.GetBytes(encrypted);

                var encryptedMessagesInBytes = rsaCryptoServiceProvider.Decrypt(buffer, true);
                encrypted = encoding.GetString(encryptedMessagesInBytes);
