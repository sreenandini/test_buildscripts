...
namespace BMC.DataAccess
{
    public sealed class SqlHelper
    {
        ...
        public static int LoadCommandTimeout()
        {
            ...
            //RegistryKey regConn = RegHKLM.OpenSubKey(@"SOFTWARE\Honeyframe");
            int nValue = 60;
            try
            {

                //string sValue = regConn.GetValue("SQLCommandTimeOut", "60").ToString();
                string sValue = BMCRegistryHelper.GetRegKeyValue(string.Empty, "SQLCommandTimeOut", "60");
                                           ...
                                           out bool mustCloseConnection)
        {
            try
            {
                ...
                command.CommandTimeout = LoadCommandTimeout();
                                          ...
                                          params SqlParameter[] commandParameters)
        {
            try
            {
                ...
                cmd.CommandTimeout = LoadCommandTimeout();
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQueryWithCommandTimeOut(SqlConnection connection, CommandType commandType,
                                       ...
                                       int commandTimeOut, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                // Call the overload that takes an array of SqlParameters
                FillDataset(connection,null, CommandType.StoredProcedure, spName, dataSet, tableNames,commandTimeOut, commandParameters);
            }
            else
            {
                // Otherwise we can just call the SP without params
